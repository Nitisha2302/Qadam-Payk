   ...
   'getReceivedResponse' => [
    ...
    'ride' => [
        ...
        'notifications' => [
            ...
            'request_cancelled' => [
                'title' => 'Дархости брон бекор карда шуд',
                'body'  => 'Ронанда масир ё вақти сафарро тағйир дод. Дархости бронкунии шумо бекор карда шуд.',
   ...
   'enquiry' => [
    ...
    'createParcelRequest' => [
        ...
        'notifications' => [
            ...
            'request_updated' => [
                'title' => 'Дархости мусофир навсозӣ шуд',
                'body'  => ':passenger сафарро аз :pickup то :destination навсозӣ кард.',
            ],
        ],
    ...
    'block' => [
     ...
     'story' => [
        ...
        'upload_success' => 'Ҳикоя бо муваффақият бор карда шуд.',
        'fetch_success' => 'Ҳикояҳо бо муваффақият гирифта шуданд.',
        'report_success' => 'Ҳикоя бо муваффақият гузориш дода шуд.',

        'story_not_found' => 'Ҳикоя ёфт нашуд.',
        'already_reported' => 'Шумо аллакай ин ҳикояро гузориш додаед.',
        'no_media' => 'Ягон файл бор карда нашудааст.',

        'delete_success' => 'Ҳикоя бо муваффақият нест карда шуд.',
        'delete_not_allowed' => 'Шумо иҷозати нест кардани ин ҳикояро надоред.',

        'cannot_view_own_story' => 'Шумо наметавонед ҳикояи худро бинед.',
        'already_viewed' => 'Ҳикоя аллакай дида шудааст.',
        'view_recorded' => 'Дидани ҳикоя бо муваффақият сабт шуд.',

        'validation' => [
            'media_required' => 'Лутфан акс ё видео бор кунед.',
            'media_file' => 'Файл бояд дуруст бошад.',
            'media_mimes' => 'Форматҳои иҷозатдодашуда: jpg, jpeg, png, mp4, mov.',
            'type_required' => 'Навъи файл ҳатмист (акс ё видео).',
            'type_invalid' => 'Навъи файл бояд акс ё видео бошад.',
            'route_string' => 'Маршрут бояд сатр бошад.',
            'city_string' => 'Шаҳр бояд сатр бошад.',
            'description_string' => 'Тавсиф бояд сатр бошад.',
            'description_max' => 'Тавсиф набояд аз 500 аломат зиёд бошад.',
            'reason_string' => 'Сабаб бояд сатр бошад.',
            'reason_max' => 'Сабаб набояд аз 255 аломат зиёд бошад.',
        ],
