...
return [
   ...
   'city' => [
    ...
    'story' => [
        ...
        'upload_success' => 'История успешно загружена.',
        'fetch_success' => 'Истории успешно получены.',
        'report_success' => 'История успешно отправлена на проверку.',

        'story_not_found' => 'История не найдена.',
        'already_reported' => 'Вы уже пожаловались на эту историю.',
        'no_media' => 'Медиафайл не загружен.',

         'delete_success' => 'История успешно удалена.',
        'delete_not_allowed' => 'У вас нет прав для удаления этой истории.',

         'cannot_view_own_story' => 'Вы не можете просматривать свою историю.',
        'already_viewed' => 'История уже просмотрена.',
        'view_recorded' => 'Просмотр истории успешно сохранён.',

        'validation' => [
            'media_required' => 'Пожалуйста, загрузите фото или видео.',
            'media_file' => 'Файл должен быть корректным.',
            'media_mimes' => 'Разрешённые форматы: jpg, jpeg, png, mp4, mov.',
            'type_required' => 'Тип обязателен (фото или видео).',
            'type_invalid' => 'Тип должен быть фото или видео.',
            'route_string' => 'Маршрут должен быть строкой.',
            ...
            'reason_max' => 'Причина не должна превышать 255 символов.',
        ],
    ],
