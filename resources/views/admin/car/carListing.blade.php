                        ...
                        <tr>
                            ...
                            <td>                                            
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <button  class="dropdown-item delete-btn-design delete-plan-btn d-flex justify-content-center" data-user-id="{{ $car->id }}" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body delete-confirmation-popup-body ">
                            <p class="delete-confirmation-popup-text delete-user-confirmation-popup-text">Do you really want to delete this item?</p>
                    </div>
